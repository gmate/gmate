...
1. Install all dependencies:
     python-webkitgtk for Todo-List plugin, see http://code.google.com/p/pywebkitgtk
...
=== Code snippets
<b>I need help creating a good snippet base. For now, there are only snippets I
got from some place, and most are outdated.</b>
